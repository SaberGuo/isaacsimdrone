...
def some_public_function(x: int):
    print("[omniperception_isaacdrone] some_public_function was called with x: ", x)
    return x**x
...
class ExampleExtension(omni.ext.IExt):
    ...
    def on_startup(self, ext_id):
        print("[omniperception_isaacdrone] startup")
    ...
    def on_shutdown(self):
        print("[omniperception_isaacdrone] shutdown")